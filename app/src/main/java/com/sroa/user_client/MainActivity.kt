...
import com.sroa.user_client.databinding.MainActivityBinding
import com.sroa.user_client.reserve.ReserveConfirmFragment
import com.sroa.user_client.reserve.ReserveDetailFragment
import com.sroa.user_client.reserve.ReserveInputFragment
import com.sroa.user_client.reserve.ReserveSelectFragment
import com.sroa.user_client.search.SearchFragment
import com.sroa.user_client.setting.SettingFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //그 외
            ...
            replaceFragment(com.sroa.user_client.MainFragment())
        }
        setActionBar()
        setNavFragment()
    }
    ...
    private fun setActionBar(){
        ...
        actionBar!!.setHomeAsUpIndicator(com.sroa.user_client.R.drawable.baseline_arrow_back_24) //왼쪽버튼 이미지 설정
    }
...
//    }
    ...
    private fun setNavFragment() {
        view.bottomNavigationView.setOnItemSelectedListener { item ->
            when (item.itemId) {
                //홈
                com.sroa.user_client.R.id.home -> {
                    replaceFragment(com.sroa.user_client.MainFragment())
                    true
                }
                //예약
                com.sroa.user_client.R.id.reserve -> {
                    replaceFragment(ReserveInputFragment())
                    true
                }
                //조회
                com.sroa.user_client.R.id.search -> {
                    replaceFragment(SearchFragment())
                    true
                }
                //설정
                com.sroa.user_client.R.id.setting -> {
    ...
    fun replaceFragment(fragment: Fragment) {
        ...
        try{
            fragmentTransaction.replace(com.sroa.user_client.R.id.bottom_nav_frame, fragment)
