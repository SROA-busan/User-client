...
import com.sroa.user_client.databinding.SearchActivityDetailBinding
import com.sroa.user_client.dto.CustomerReservationDetailInfo
import com.sroa.user_client.dto.SearchData
import com.sroa.user_client.evalution.EvaluationActivity
...
class SearchDetailActivity : AppCompatActivity() {
    ...
    private fun setRepairButton(scheduleNum: Long){
        binding.searchDetailRepairButton.setOnClickListener {
            val intent = Intent(applicationContext, com.sroa.user_client.MainActivity::class.java)
